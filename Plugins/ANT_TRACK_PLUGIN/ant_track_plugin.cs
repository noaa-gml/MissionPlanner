...
{
    public class ant_track_plugin : MissionPlanner.Plugin.Plugin
    {
        //TabPage
        private System.Windows.Forms.TabPage tab = new System.Windows.Forms.TabPage();
        private TabControl tabctrl;
        private AntTracker tracker = new AntTracker();

        public override string Name
        {
            get { return "Antenna Tracker"; }
        }
        ...
        public override bool Loaded()
        {
            ...
            tab.Text = "ANT Tracker";
            // set the internal id
            tab.Name = "ANT_Tracker";
            // add the usercontrol to the tabpage
            tab.Controls.Add(tracker);
        ...
        private void forceSettings()
        {
            ...
            if (tabs == null)
            {
                CustomMessageBox.Show("Restart Mission Planner to enable ANT Track Tab. Disable Plugin if Not Required CTRL-P");
